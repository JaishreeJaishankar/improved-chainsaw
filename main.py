...
def main():
    ...
    parser.add_argument("--merge-cidrs", action="store_true", help="Apply CIDR merging to optimize rules")
    ...
    if args.html_report:
        ...
        ml_rules = analyzer.generate_ml_rules(os.path.join(args.output_dir, "visualizations"))
    ...
    single_rule_opt = analyzer.optimize_single_rule(merge_cidrs=args.merge_cidrs)
    print("\nOptimized Single Rule:")
